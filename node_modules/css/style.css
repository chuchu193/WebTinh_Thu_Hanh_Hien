...
@font-face {
  ...
  src: url('../fonts/tw-social-icons.eot');
  src: url('../fonts/tw-social-icons.eot') format('embedded-opentype'),
       url('../fonts/tw-social-icons.woff') format('woff'),
       url('../fonts/tw-social-icons.ttf') format('truetype'),
       url('../fonts/tw-social-icons.svg') format('svg');
  font-weight: normal;
  font-style: normal;
}
